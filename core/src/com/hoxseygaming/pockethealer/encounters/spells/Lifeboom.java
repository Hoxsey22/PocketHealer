...
public class Lifeboom extends Periodical {
    ...
    public Lifeboom(Player player,Assets assets)  {
        super(player, "Lifeboom","A small heal that is healed over time.",0, EffectType.TEMPHEAL, 1, 7, 15,
    ...
    public Lifeboom(Player player, Renew parent, Assets assets)  {
        super(player, "Lifeboom","A small heal that is healed over time.",0, EffectType.TEMPHEAL, 1, parent.output, 0,
